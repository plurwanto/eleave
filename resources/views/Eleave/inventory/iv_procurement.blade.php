...
@section('title','Eleave | Procurement List')
...
<div class="portlet box green">
    <div class="portlet-title">
        <div class="caption">
            <i class="fa fa-cart-plus"></i>Procurement List
        </div>
        <div class="tools"></div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="dt-buttons">
                        <a class="btn btn-default btn-circle btn-sm" tabindex="0" aria-controls="sample_2" href="{{ URL::to('eleave/inventory_procurement/add') }}"><i class="fa fa-plus"></i> Add</a>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $table = $('#usertable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": `${webUrl}eleave/inventory_procurement/get_data`,
                "dataType": "json",
                "type": "POST",
