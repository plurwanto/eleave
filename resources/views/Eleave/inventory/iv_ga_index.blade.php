    ...
    <div class="portlet-body">
        <div class="tabbable-line boxless tabbable-reversed">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="{{url('eleave/inventory/all_request')}}" id="tab1" aria-expanded="true"> Request Summary </a>
                </li>
                <li class="">
                    <a href="{{url('eleave/inventory/all_processed')}}" id="tab2" aria-expanded="false"> Processed </a>
                </li>
            </ul>
...
//            });
            ...
            $table = $('#usertable').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": `${webUrl}eleave/inventory/get_all_data`,
                    "dataType": "json",
                    "type": "POST",
