...
@section('title','Eleave | Cash Advance Edit')
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 err">
                            <input type="text" class="form-control" value="<?=$ca->ca_subject;?>" name="subject_name" id="subject_name" maxlength="255">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Total</label>
                        <div class="col-md-4">
                            <input readonly="readonly" type="text" class="form-control" name="ca_total" id="ca_total" value="<?=$ca->ca_total;?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-2 control-label" id="sp_ca_date"><?=$ca->ca_date;?></label>
                    </div>
                </div>
                                ...
                                if (!empty($ca->detail)) {
                                    ...
                                    foreach ($ca->detail as $key => $value) {
                                        ...
                                        <tr id="baris<?=$numb;?>">
                                            <td>
                                                <div class="err">
                                                    <input type="hidden" value="<?=$value->ca_id_detail;?>" name="ca_id_detail[]" id="ca_id_detail_<?=$numb;?>">
                                                    <input type="text" value="<?=$value->ca_date_detail;?>" class="form-control datepicker row-id" placeholder="Enter date" name="ca_date_detail[]" id="ca_date_detail_<?=$numb;?>" autocomplete="off">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="err">
                                                    <input type="text" value="<?=$value->ca_project;?>" class="form-control" name="ca_project[]" id="ca_project_<?=$numb;?>" autocomplete="off">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="err">
                                                    <input type="text" value="<?=$value->ca_detail_project;?>" class="form-control" name="ca_detail[]" id="ca_detail_<?=$numb;?>" autocomplete="off">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="err">
                                                    <input type="text" value="<?=$value->ca_amount;?>" name="ca_amount[]" id="ca_amount_<?=$numb;?>" placeholder="0" onkeyup="valangka(this); loadgrandtotal();" class="form-control text-right" value="" autocomplete="off">
                                                </div>
                                            </td>
...
//                        .closest('.form-group').removeClass('has-error'); // set error class to the control group
        ...
        $(".addmore").on('click', function () {
            ...
            html += '<td><div class="err"><input type="hidden" name="ca_id_detail[]" id="ca_id_detail_' + i + '"><input type="text" class="form-control datepicker row-id" placeholder="Enter date" name="ca_date_detail[]" id="ca_date_detail_' + i + '" autocomplete="off"></div></td>';
