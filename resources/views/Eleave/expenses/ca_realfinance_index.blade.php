...
<div class="portlet box green">
    ...
    <div class="portlet-body">
        <ul class="nav nav-tabs">
            <li class="">
                <a href="{{url('eleave/cash_advanceApproval/all_request')}}" id="tab1" aria-expanded="false"> Request <span id="amount_req" class=""> </span></a>
            </li>
             <li class="active">
                <a href="{{url('eleave/cash_advanceApproval/realization?status=in_process')}}" id="tab2" aria-expanded="true"> Realization <span id="amount_real" class=""> </span></a>
            </li>
            <li class="">
