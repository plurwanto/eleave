...
<div class="portlet box green">
    ...
    <div class="portlet-body">
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="{{url('eleave/cash_advanceApproval?index=1')}}" id="tab1" aria-expanded="true"> Request <span id="amount_req" class=""> </span></a> 
            </li>
            <li class="">
                <a href="{{url('eleave/cash_advanceApproval?index=2')}}" id="tab2" aria-expanded="false"> Realization <span id="amount_real" class=""> </span></a>
            </li>
...
//        } else {
        var url = `${webUrl}eleave/cash_advanceApproval/getdata`;
        //  }
        ...
        $table = $('#usertable').DataTable({
            ...
            "fnDrawCallback": function (oSettings) {
                ...
                ($('#txtnotifreal').val() > 0 ? $('#ca_approval').addClass('badge badge-danger') : $('#ca_approval').removeClass('badge badge-danger'));
            }
        });
