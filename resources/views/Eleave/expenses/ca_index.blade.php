...
@section('title','Eleave | Cash Advance List')
    ...
    <div class="portlet-body">
        <div class="tabbable-line boxless tabbable-reversed">
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="{{url('eleave/cash_advance?index=1')}}" id="tab1" aria-expanded="true"> Request </a>
                </li>
                <li class="">
                    <a href="{{url('eleave/cash_advance?index=2')}}" id="tab2" aria-expanded="false"> Realization </a>
                </li>
                <li class="">
                    <a href="{{url('eleave/cash_advance?index=done')}}" id="tab3" aria-expanded="false"> History </a>
                </li>
                <li class="pull-right btn green-haze btn-outline btn-circle btn-xs">
                        ...
                        <table class="table table-striped table-bordered table-condensed nowrap" width="100%" id="usertable">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 120px">Subject<br />
...
s                        <option value="">- Choose -</option>\n\
        ...
        if ($('#notif').val() == "notif") {
            ...
            var url = `${webUrl}eleave/cash_advance/getdata`;
        }
...
//                    html += '<td> ' + response.data[i]['ts_activity'] + '</td>';
    ...
    $(document).on('click', '.reject', function () {
        if (confirm("Are you sure delete ?  ")) {
            ...
            $.ajax({
                type: 'POST',
                url: `${webUrl}eleave/cash_advance/delete`,
                dataType: 'json',
                headers: {
