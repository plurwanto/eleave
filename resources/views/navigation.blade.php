    ...
    <div class="page-header">
        ...
        <div class="page-header-top">
            <div class="container">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="{{ URL::asset(env('IMAGES_PATH').'/logo_small.png') }}" alt="logo" class="logo-default" width="150px" style="margin-top:15px;" /> </a>
                    </a>
                </div>
                <!-- END LOGO -->
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user dropdown-dark">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                ...
                                <span class="username username-hide-mobile">Ozi Muhamad</span>
                            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li aria-haspopup="true" class="menu-dropdown classic-menu-dropdown ">
                            ...
                            <ul class="dropdown-menu pull-left">
                                ...
                                <li aria-haspopup="true" class="dropdown-submenu ">
                                    <a href="javascript:;" class="nav-link nav-toggle ">
                                        <i class="fa fa-pencil-square-o"></i> Apps
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li aria-haspopup="true" class=" ">
