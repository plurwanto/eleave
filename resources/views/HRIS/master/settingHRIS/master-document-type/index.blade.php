...
@section('title', 'Master Data Document Type')
@section('breadcrumbs')
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            @php
                            $a=1;
                                for($i = 0; $i < count($documentType->result); $i++){
                                if($documentType->result[$i]->doc_type_active =='Y'){
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$documentType->result[$i]->doc_type_name.'</td>
                                        <td>'.$documentType->result[$i]->doc_dept_name.'</td>
                                        <td>'.$status.'</td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $documentType->result[$i]->doc_type_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $documentType->result[$i]->doc_type_id .'" onclick="get_modal(this)">
