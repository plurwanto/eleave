...
<form id="formInputEdit"  class="form form-horizontal">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="name" value="{{$row->result->fix_allow_master_name}}" autocomplete="off" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="mt-radio-list">
                                            <label class="mt-radio mt-radio-outline">
                                                @if($row->result->fix_allow_master_active =='Y')
    ...
    <input type="hidden" name="id" value="{{$row->result->fix_allow_master_id}}">
