...
@section('title', 'Master Data Fix Allowance Master')
@section('breadcrumbs')
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            $a=1;
                                ...
                                if($fixAllowanceMaster->result[$i]->fix_allow_master_active =='Y'){
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$fixAllowanceMaster->result[$i]->fix_allow_master_name.'</td>
                                        <td>'.$status.'</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $fixAllowanceMaster->result[$i]->fix_allow_master_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $fixAllowanceMaster->result[$i]->fix_allow_master_id .'" onclick="get_modal(this)">
