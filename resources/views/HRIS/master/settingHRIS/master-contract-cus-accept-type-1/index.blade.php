...
@section('title', 'Master Customer Accept Type 1')
@section('breadcrumbs')
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            @php
                            $a=1;
                                for($i = 0; $i < count($contractCusAcceptType1->result); $i++){
                                if($contractCusAcceptType1->result[$i]->cus_accept_typ_1_active =='Y'){
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$contractCusAcceptType1->result[$i]->cus_accept_typ_1_name.'</td>
                                        <td>'.$contractCusAcceptType1->result[$i]->cus_name.'</td>
                                        <td>'.$status.'</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $contractCusAcceptType1->result[$i]->cus_accept_typ_1_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $contractCusAcceptType1->result[$i]->cus_accept_typ_1_id .'" onclick="get_modal(this)">
