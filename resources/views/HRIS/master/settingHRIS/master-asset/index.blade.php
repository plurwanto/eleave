                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    ...
                    <table class="table table-striped table-bordered table-advance table-hover" id="users-table">
                            ...
                            $a=1;
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$asset->result[$i]->brand_name.'</td>
                                        <td>'.$asset->result[$i]->type_name.'</td>
                                        <td>'.$asset->result[$i]->model.'</td>
                                        <td>'.$asset->result[$i]->vendor_name.'</td>
                                        <td>'.$asset->result[$i]->status.'</td>
                                        <td>'.$asset->result[$i]->nama.'</td>
                                        <td>'.$asset->result[$i]->updated_at.'</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $asset->result[$i]->ass_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $asset->result[$i]->ass_id .'" onclick="get_modal(this)">
