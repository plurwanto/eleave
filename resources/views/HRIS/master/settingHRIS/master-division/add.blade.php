                        ...
                        <div class="col-md-12 ">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Division Name <font color="red">*</font></label>
                                    <div class="col-md-9">
                                        <input type="text" autocomplete="off" name="div_name" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="mt-radio-list">
                                            <label class="mt-radio mt-radio-outline">
                                                <input type="radio" name="div_active" id="optionsRadios22" value="Y" checked> Active
                                                <span></span>
                                            </label>
                                            <label class="mt-radio mt-radio-outline">
                                                <input type="radio" name="div_active" id="optionsRadios22" value="N"> No Active
                                                <span></span>
                                            </label>
                                        </div>
                                    </div>
