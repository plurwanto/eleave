...
<form id="formInputEdit"  class="form form-horizontal">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" autocomplete="off" name="div_name" value="{{$row->result->div_name}}" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    <input type="hidden" name="id" value="{{$row->result->div_id}}">
