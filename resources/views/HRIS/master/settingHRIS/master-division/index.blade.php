...
@section('title', 'Master Data Division')
@section('breadcrumbs')
                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            $a=1;
                                ...
                                if($division->result[$i]->div_active =='Y'){
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$division->result[$i]->div_name.'</td>
                                        <td>'.$status.'</td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $division->result[$i]->div_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $division->result[$i]->div_id .'" onclick="get_modal(this)">
        ...
        <script type="text/javascript">
            ...
            function get_modal(e)
            {
                ...
                if (action == 'useraccess') {
                    $('#modalAction').modal({backdrop: 'static', show: true, keyboard: false});
                    var id = $(this).attr('data-column');
                    $.get("{{ URL::asset(env('APP_URL').'/hris/master/hris-setting/useraccess') }}",
                    {
                        id: arr[0]
                    },
                    function (data) {
