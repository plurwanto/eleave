...
<form id="formInputEdit"  class="form form-horizontal">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-body">
                                    ...
                                    <div class="col-md-9">
                                        <select name="master" class="form-control">
                                            ...
                                            @for($i = 0; $i < count($fixAllowanceMaster->result); $i++)
                                                @if($fixAllowanceMaster->result[$i]->fix_allow_master_id == $row->result->fix_allow_master_id)
                                                    <option value="{{$fixAllowanceMaster->result[$i]->fix_allow_master_id}}" selected>{{$fixAllowanceMaster->result[$i]->fix_allow_master_name}}</option>
                                                @else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="name" value="{{ $row->result->fix_allow_type_name }}" autocomplete="off" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="mt-radio-list">
                                            <label class="mt-radio mt-radio-outline">
                                                @if($row->result->fix_allow_type_active =='Y')
    ...
    <input type="hidden" name="id" value="{{$row->result->fix_allow_type_id}}">
