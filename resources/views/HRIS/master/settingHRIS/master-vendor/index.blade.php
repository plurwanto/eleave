                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                            ...
                            $a=1;
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$vendor->result[$i]->vendor_name.'</td>
                                        <td>'.$vendor->result[$i]->vendor_mobile.'</td>
                                        <td>'.$vendor->result[$i]->vendor_address.'</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $vendor->result[$i]->ass_vendor_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $vendor->result[$i]->ass_vendor_id .'" onclick="get_modal(this)">
