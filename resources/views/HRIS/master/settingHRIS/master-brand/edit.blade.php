...
<form id="formInputEdit"  class="form form-horizontal">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Brand Name <font color="red">*</font></label>
                                    <div class="col-md-9">
                                        <input type="text" autocomplete="off" name="brand_name" value="{{$row->result->brand_name}}"  class="form-control" >
                                    </div>
                                </div>
                        </div>
                </div>
    ...
    <input type="hidden" name="id" value="{{$row->result->ass_brand_id}}">
