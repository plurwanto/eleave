...
<form id="formInputEdit"  class="form form-horizontal">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="date" value="{{date('d-M-Y', strtotime($row->result->ts_hol_date))}}" autocomplete="off" data-date-format="dd/mm/yyyy" class="form-control  date-picker" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Name <font color="red">*</font></label>
                                    <div class="col-md-9">
                                        <input type="text" name="name" value="{{$row->result->ts_hol_name}}" autocomplete="off" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    <input type="hidden" name="id" value="{{$row->result->ts_hol_id}}">
