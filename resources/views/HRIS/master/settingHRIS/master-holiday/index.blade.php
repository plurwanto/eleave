...
@section('title', 'Master Data Holiday')
@section('breadcrumbs')
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            @php
                            $a=1;
                                for($i = 0; $i < count($holiday->result); $i++){
                                if($holiday->result[$i]->ts_hol_active =='Y'){
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$holiday->result[$i]->ts_hol_name.'</td>
                                        <td>'.date('d-M-Y', strtotime($holiday->result[$i]->ts_hol_date)).'</td>
                                        <td>'.$status.'</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $holiday->result[$i]->ts_hol_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $holiday->result[$i]->ts_hol_id .'" onclick="get_modal(this)">
