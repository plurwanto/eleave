                    ...
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            $a=1;
                                ...
                                if($branch->result[$i]->br_active =='Y'){
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$branch->result[$i]->br_code.'</td>
                                        <td>'.$branch->result[$i]->br_name.'</td>
                                        <td>'.$branch->result[$i]->br_address.'</td>
                                        <td>'.$branch->result[$i]->br_phone.'</td>
                                        <td>'.$branch->result[$i]->br_fax.'</td>
                                        <td>'.$branch->result[$i]->br_country.'</td>
                                        <td>'. $status .'</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $branch->result[$i]->br_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $branch->result[$i]->br_id .'" onclick="get_modal(this)">
