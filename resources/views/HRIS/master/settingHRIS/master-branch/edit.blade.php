...
<form id="formInputEdit"  class="form form-horizontal">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Branch Name <font color="red">*</font></label>
                                    <div class="col-md-9">
                                        <input type="text" autocomplete="off" name="br_name" value="{{$row->result->br_name}}" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Branch Code <font color="red">*</font></label>
                                    <div class="col-md-9">
                                        <input type="text" autocomplete="off" name="br_code" value="{{$row->result->br_code}}" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Address <font color="red">*</font></label>
                                    <div class="col-md-9">
                                        <textarea type="text" name="address" class="form-control" >{{$row->result->br_address}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Phone</label>
                                    <div class="col-md-9">
                                        <input type="text" name="phone" class="form-control" value="{{$row->result->br_phone}}" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Fax</label>
                                    <div class="col-md-9">
                                        <input type="text" name="fax" class="form-control" value="{{$row->result->br_fax}}" >
                                    </div>
                                </div>
                        </div>
                </div>
    ...
    <div class="modal-footer">
        <input type="hidden" name="id" value="{{$row->result->br_id}}">
                ...
                success: function (data) {
                    ...
                    if (data.response_code == '200') {
                        swal({title: "Input Successfully", type: "success"},
                                function () {
                                    window.location = "{{ URL::asset(env('APP_URL').'/hris/master/hris-setting') }}";
