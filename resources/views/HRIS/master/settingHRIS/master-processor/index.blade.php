...
@section('title', 'Master Data processor')
@section('breadcrumbs')
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                            ...
                            $a=1;
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$processor->result[$i]->processor_name.'</td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $processor->result[$i]->ass_processor_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $processor->result[$i]->ass_processor_id .'" onclick="get_modal(this)">
