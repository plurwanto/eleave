...
<form id="formInputEdit"  class="form form-horizontal">
                    ...
                    <div class="col-md-12 ">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label">processor Name <font color="red">*</font></label>
                                <div class="col-md-8">
                                    <input type="text" autocomplete="off" name="processor_name" value="{{$row->result->processor_name}}"  class="form-control" >
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <input type="hidden" name="id" value="{{$row->result->ass_processor_id}}">
