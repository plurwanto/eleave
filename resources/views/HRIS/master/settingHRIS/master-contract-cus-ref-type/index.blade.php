...
@section('title', 'Master Data Customer Reference Type')
@section('breadcrumbs')
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            @php
                            $a=1;
                                for($i = 0; $i < count($contractCusRefType->result); $i++){
                                if($contractCusRefType->result[$i]->cus_ref_typ_active =='Y'){
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$contractCusRefType->result[$i]->cus_ref_typ_name.'</td>
                                        <td>'.$contractCusRefType->result[$i]->cus_name.'</td>
                                        <td>'.$status.'</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $contractCusRefType->result[$i]->cus_ref_typ_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $contractCusRefType->result[$i]->cus_ref_typ_id .'" onclick="get_modal(this)">
          ...
          function get_modal(e) 
            {
                ...
                if (action == 'add') {
                    $('#modalAction').modal({backdrop: 'static', show: true});
