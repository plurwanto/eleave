...
@section('title', 'Master Data Payroll Approval')
@section('breadcrumbs')
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            @php
                            $a=1;
                                for($i = 0; $i < count($approval->result); $i++){
                                if($approval->result[$i]->status =='1'){
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$approval->result[$i]->menu_name.'</td>
                                        <td>'.$approval->result[$i]->menu_code.'</td>
                                        <td>'.$status.'</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $approval->result[$i]->menu_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $approval->result[$i]->menu_id .'" onclick="get_modal(this)">
