...
@section('title', 'Master Data Customer Accept Type 2')
@section('breadcrumbs')
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            @php
                            $a=1;
                                for($i = 0; $i < count($contractCusAcceptType2->result); $i++){
                                if($contractCusAcceptType2->result[$i]->cus_accept_typ_2_active =='Y'){
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$contractCusAcceptType2->result[$i]->cus_accept_typ_2_name.'</td>
                                        <td>'.$contractCusAcceptType2->result[$i]->cus_name.'</td>
                                        <td>'.$status.'</td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $contractCusAcceptType2->result[$i]->cus_accept_typ_2_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $contractCusAcceptType2->result[$i]->cus_accept_typ_2_id .'" onclick="get_modal(this)">
