...
<form id="formInputEdit"  class="form form-horizontal">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-body">
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Type Name <font color="red">*</font></label>
                                    <div class="col-md-9">
                                        <input type="text" autocomplete="off" name="type_name" value="{{$row->result->type_name}}"  class="form-control" >
                                    </div>
                                </div>
                        </div>
                </div>
    ...
    <input type="hidden" name="id" value="{{$row->result->ass_type_id}}">
