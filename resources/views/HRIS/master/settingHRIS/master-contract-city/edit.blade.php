...
<form id="formInputEdit"  class="form form-horizontal">
                        ...
                        <div class="col-md-12 ">
                            <div class="form-body">
                                    ...
                                    <div class="col-md-9">
                                        <select name="city" class="form-control select2">
                                            ...
                                            @for($i = 0; $i < count($city->result); $i++)
                                                @if($city->result[$i]->city_id == $row->result->city_id)
                                                <option value="{{$city->result[$i]->city_id}}" selected>{{$city->result[$i]->city_name}}</option>
                                                @else
                                                <option value="{{$city->result[$i]->city_id}}">{{$city->result[$i]->city_name}}</option>
                                                @endif
                                            @endfor
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" name="name" value="{{$row->result->cont_city_name}}" autocomplete="off" class="form-control" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="mt-radio-list">
                                            <label class="mt-radio mt-radio-outline">
                                                @if($row->result->cont_city_active =='Y')
                                            ...
                                            <label class="mt-radio mt-radio-outline">
                                                @if($row->result->cont_city_active !='Y')
                                                    <input type="radio" name="active" id="optionsRadios23" value="N" checked>No Active
                                                @else
                                                    <input type="radio" name="active" id="optionsRadios22" value="Y">No Active
                                                @endif
                                                <span></span>
                                            </label>
                                        </div>
    ...
    <input type="hidden" name="id" value="{{$row->result->cont_city_id}}">
