...
@section('title', 'Master Data Contract City')
@section('breadcrumbs')
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            ...
                            @php
                            $a=1;
                                for($i = 0; $i < count($contractCity->result); $i++){
                                if($contractCity->result[$i]->cont_city_active =='Y'){
                                ...
                                echo'<tr>
                                        <td>'.$a++.'</td>
                                        <td>'.$contractCity->result[$i]->cont_city_name.'</td>
                                        <td>'.$contractCity->result[$i]->cus_name.'</td>
                                        <td>'.$contractCity->result[$i]->city_name.'</td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">';
                                                    if($access->menu_acc_edit){
                                                        echo '<li>
                                                                <a dataaction="edit" title="edit" dataid="'. $contractCity->result[$i]->cont_city_id .'" onclick="get_modal(this)">
                                                    ...
                                                    if($access->menu_acc_del){
                                                        ...
                                                        echo '<li>
                                                                <a dataaction="delete" title="delete" dataid="'. $contractCity->result[$i]->cont_city_id .'" onclick="get_modal(this)">
