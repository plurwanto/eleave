...
<form id="formInputAccess"  class="form form-horizontal">
            ...
            <div class="row">
                <div class="portlet-body form">
                        <div class="col-md-12">
                            ...
                            <td>{{$menu->profile->nama}}</td>
                            </tr>
                            <tr>
                            <td><b>Position</b></td>
                            <td style="width:20px; text-align:center">:</td>
                            <td>{{$menu->profile->div_name}}</td>
                            </tr>
                            </table>
                            <br>
                                        ...
                                        for($b = 0; $b < count($menu->menu[$a]->sub_menu); $b++){
                                            ...
                                            if(count($menu->menu[$a]->sub_menu[$b]->sub_menu) > 0){
                                                ...
                                                for($c = 0; $c < count($menu->menu[$a]->sub_menu[$b]->sub_menu); $c++){
                                                    ...
                                                    $access3 = $menu->menu[$a]->sub_menu[$b]->sub_menu[$c]->access;
                                                    if($access3){
                                                        if($access3->menu_acc_view == 1){
                                                            $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_view'.$xx.'" checked></td>';
                                                        }else{
                                                            $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_view'.$xx.'"></td>';
                                                        }
                                                        if($access3->menu_acc_add == 1){
                                                            $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_add'.$xx.'" checked></td>';
                                                        }else{
                                                            $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_add'.$xx.'"></td>';
                                                        }
                                                        if($access3->menu_acc_edit == 1){
                                                            $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_edit'.$xx.'" checked></td>';
                                                        }else{
                                                            $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_edit'.$xx.'"></td>';
                                                        }
                                                        if($access3->menu_acc_del == 1){
                                                            $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_del'.$xx.'" checked></td>';
                                                        }else{
                                                            $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_del'.$xx.'"></td>';
                                                        }
                                                        if($access3->menu_acc_approve == 1){
                                                            $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_approve'.$xx++.'" checked></td>';
                                                        }else{
                                                ...
                                                $str .='<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-caret-right"></i>
                                                        ...
                                                        $access2 = $menu->menu[$a]->sub_menu[$b]->access;
                                                        if($access2){
                                                            if($access2->menu_acc_view == 1){
                                                                $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_view'.$xx.'" checked></td>';
                                                            }else{
                                                                $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_view'.$xx.'"></td>';
                                                            }
                                                            if($access2->menu_acc_add == 1){
                                                                $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_add'.$xx.'" checked></td>';
                                                            }else{
                                                                $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_add'.$xx.'"></td>';
                                                            }
                                                            if($access2->menu_acc_edit == 1){
                                                                $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_edit'.$xx.'" checked></td>';
                                                            }else{
                                                                $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_edit'.$xx.'"></td>';
                                                            }
                                                            if($access2->menu_acc_del == 1){
                                                                $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_del'.$xx.'" checked></td>';
                                                            }else{
                                                                $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_del'.$xx.'"></td>';
                                                            }
                                                            if($access2->menu_acc_approve == 1){
                                                                $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_approve'.$xx++.'" checked></td>';
                                                            }else{
                                                                $str .='<td><input type="checkbox" class="big-checkbox" value="1" name="menu_acc_approve'.$xx++.'"></td>';
                                                            }
    ...
    <input type="hidden" value="{{$menu->profile->user_id}}" name="user_id">
    <input type="hidden" value="{{$menu->profile->email}}" name="email" checked>
    <input type="hidden" value="{{$menu->profile->nama}}" name="nama" checked>
