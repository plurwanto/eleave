        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var dataTable = $('#users-table').DataTable({
                    ...
                    "order": [[ 0, "DESC" ]],
                    "ajax": {
                        "url": "{{ URL::asset(env('APP_URL').'/hris/customer/listdata-not-approved') }}",
                        "dataType": "json",
                        "type": "POST",
            ...
            function get_modal(e)
            {
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        $.get("{{ URL::asset(env('APP_URL').'/hris/customer/do-approve') }}",
                            {
                                link: link,
                                id: arr[0]
                            },
                            function (data) {
                                ...
                                function () {
                                    window.location = "{{ URL::asset(env('APP_URL').'/hris/customer?link=not-approved') }}";
