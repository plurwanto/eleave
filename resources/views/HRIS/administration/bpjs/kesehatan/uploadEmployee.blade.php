...
<script type="text/javascript">
        ...
        $(document).on("submit", "#formInput", function (event)
        {
            ...
            $.ajax({
                ...
                url: "{{ URL::asset(env('APP_URL').'/hris/administration/bpjs/kesehatan/do-upload-employee') }}",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
                                ...
                                swal({
                                    ...
                                    closeOnCancel: false
                                        ...
                                        function (isConfirm) {
                                            ...
                                            if (isConfirm) {
                                                var link = "{{URL::asset(env('APP_URL').'/hris/administration/bpjs/kesehatan?link=log-error&id=')}}"+ data.wrong_id;
                                                link = link.replace(/&amp;/g, '&') ;
