    ...
    <div class="pull-right">
        ...
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu pull-right">
                ...
                @php
                    if($access->menu_acc_add == 1){
                        echo  '<a href="'. URL::asset(env('APP_URL').'/hris/administration/bpjs/ketenagakerjaan/template-update') .'"><i class="fa fa-file-excel-o" style="
                margin-right: 3px;
                "></i>Template </a>';
                    }
                @endphp
                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                        <div class="portlet-body">
                            <div class="pull-right">
                                <select data-column="6" name="type" class="search-input-select form-control input-sm">
                                    <option value="">ALL</option>
                                    <option value="1">ketenagakerjaan Not Empty</option>
                                    <option value="2">ketenagakerjaan Empty</option>
                                    <option value="3">Pensiun Not Empty</option>
                                    <option value="4">Pensiun Empty</option>
                            ...
                            <th></th>
                                ...
                                <th><input type="text" data-column="4"  class="search-input-text form-control input-sm   border-rounded" placeholder="Search BPJS Pensiun"></th>
                                <th><input type="text" data-column="5"  class="search-input-text form-control input-sm   border-rounded" placeholder="Search Created By"></th>
                                <th></th>
                            </tr>
                            </thead>
                        </table>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var dataTable = $('#users-table').DataTable({
                    ...
                    "order": [[ 8, "DESC" ]],
                    "ajax": {
                        "url": "{{ URL::asset(env('APP_URL').'/hris/administration/bpjs/ketenagakerjaan/listdata-employee') }}",
                        "dataType": "json",
                        "type": "POST",
                    ...
                    "columns": [
                        ...
                        { data: 'mem_jamsostek', name: 'mem_jamsostek' },
                        { data: 'mem_bpjs_pen', name: 'mem_bpjs_pen' },
            ...
            function get_modal(e)
            {
                ...
                if (action == 'filter') {
                    ...
                    $.get("{{ URL::asset(env('APP_URL').'/hris/administration/bpjs/ketenagakerjaan/filter') }}",
                    function (data) {
                ...
                if (action == 'upload') {
                    $('#modalAction').modal({backdrop: 'static', show: true, keyboard: false});
                    $.get("{{ URL::asset(env('APP_URL').'/hris/administration/bpjs/ketenagakerjaan/upload-employee') }}",
                    function (data) {
                        $(".modal-content").html(data);
                    });
                }
            ...
            {
                if (elm.value != '') {
                    window.location = "{{ URL::asset(env('APP_URL').'/hris/administration/bpjs/ketenagakerjaan?link=employee') }}?link="+ elm.value;
                }
            }
        </script>
@endsection
