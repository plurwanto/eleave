        ...
        <div class="portlet-body" style="padding: 8px 15px;">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group form-margin-0">
                        <div>
                            <label style="font-weight: bold;">BPJS Ketenagakerjaan No</label>
                            <div>{{ $hasil->result->bpjs_ket_number }}</div>
                        </div>
                    </div>
                    <div class="form-group form-margin-0">
                        <div>
                            <label style="font-weight: bold;">Ketenagakerjaan Amount</label>
                            <div>{{ $hasil->result->ket_total }}</div>
                        </div>
                    </div>
                    <div class="form-group form-margin-0">
                        <div>
                            <label style="font-weight: bold;">BPJS Pensiun No</label>
                            <div>{{ $hasil->result->bpjs_pen_number }}</div>
                        </div>
                    </div>
                    <div class="form-group form-margin-0">
                        <div>
                            <label style="font-weight: bold;">Pensiun Amount</label>
                            <div>{{ $hasil->result->pen_total }}</div>
                        </div>
                    </div>
                    <div class="form-group form-margin-0">
                        <div>
                            <label style="font-weight: bold;">Basic Amount</label>
                            <div>{{ $hasil->result->pen_basic }}</div>
                        </div>
                    </div>
                    <div class="form-group form-margin-0">
                        <div>
                            <label style="font-weight: bold;">Company Amount</label>
                            <div>{{ $hasil->result->pen_company }}</div>
                        </div>
                    </div>
                    <div class="form-group form-margin-0">
                        <div>
                            <label style="font-weight: bold;">Employee Amount</label>
                            <div>{{ $hasil->result->pen_employee }}</div>
                        </div>
                    </div>
                </div>
            </div>
