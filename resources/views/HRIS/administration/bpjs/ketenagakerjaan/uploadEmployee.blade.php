...
<script type="text/javascript">
        ...
        $(document).on("submit", "#formInput", function (event)
        {
            ...
            $.ajax({
                ...
                url: "{{ URL::asset(env('APP_URL').'/hris/administration/bpjs/ketenagakerjaan/do-upload-employee') }}",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
                ...
                success: function (data) {
                    ...
                    if (data.response_code == '200') {
                        swal({title: "Input Successfully", type: "success"},
                                function () {
                                    window.location = "{{ URL::asset(env('APP_URL').'/hris/administration/bpjs/ketenagakerjaan?link=employee') }}";
