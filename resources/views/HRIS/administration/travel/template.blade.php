...
<form id="formInputTemplate" class="form form-horizontal">
...
<script type="text/javascript">
 ...
 //submit Detail Contract
    ...
    $(document).on("submit", "#formInputTemplate", function (event)
        {            var cus_id = $('#cus_id_filt').val();
            ...
            $.ajax({
                ...
                url: "{{ URL::asset(env('APP_URL').'/hris/administration/travel/do-template-excel') }}",
                data:"cus_id="+cus_id+"&link="+link,
                processData: false,
                contentType: false,
                cache: false,
                timeout: 600000,
