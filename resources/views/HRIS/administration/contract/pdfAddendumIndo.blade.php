...
<body>
    ...
    <div id="content">
        <div class="content-header">
            <div>ADDENDUM PERJANJIAN KEMITRAAN</div>
            <div>ANTARA</div>
            <div>PT ELABRAM SYSTEMS</div>
            <div>DENGAN</div>
        ...
        <div class="content-text">
            ...
            <div class="content-party">
                <ol type="1">
                    <li>
                        ...
                        sebagai <span>PIHAK PERTAMA</span>.
                    </li>
                    <li>
                        <table>
                ...
                untuk selanjutnya disebut <span>PIHAK KEDUA</span>.
            </div>
            <div class="content-introduction">
                Terlebih dahulu kedua belah pihak menerangkan bahwa antara <span>PIHAK PERTAMA</span> dan <span>PIHAK KEDUA</span> telah ditandatangani
                Perjanjian kemitraan No. (<span>{{$contract->cont_no_new}}</span>) Berdasarkan hal tersebut di atas, <span>PIHAK PERTAMA</span> dan <span>PIHAK
                KEDUA</span> sepakat dan mengikatkan diri untuk melakukan Addendum Perjanjian kemitraan menjadi sebagai berikut :
            </div>
            <div class="article-1">
                <div class="article-1-header">
                    <div>Pasal 1</div>
                </div>
                Mengubah Pasal 3 Perjanjian kemitraan menjadi sebagai berikut.:
                <ol type="1">
                    <li>
                    Perjanjian kemitraan diperpanjang selama {{$contract->interval_contract}} bulan terhitung mulai tanggal <span>{{$contract->start_date_day_numb}}</span> <span>{{$contract->start_date_month}}</span> <span>{{$contract->start_date_year}}</span> dan akan berakhir pada tanggal
                    ...
                    yang tercantum dalam Perjanjian ini. Bila Perjanjian kemitraan ini tidak akan diperbaharui, <span>PIHAK PERTAMA</span> akan
                    melakukan pemberitahuan peringatan akhir masa perjanjian kepada <span>PIHAK KEDUA</span> dalam periode empat (4) minggu
                    </li>
                </ol>
            </div>
            <div class="article-2">
                ...
                <ol type="1">
                    <li>
                        Addendum Perjanjian kemitraan ini mulai berlaku dan mengikat kedua belah pihak sejak tanggal <span>{{$contract->start_date_day_numb}}</span> <span>{{$contract->start_date_month}}</span> <span>{{$contract->start_date_year}}</span> sd <span>{{$contract->end_date_day_numb}}</span> <span>{{$contract->end_date_month}}</span> <span>{{$contract->end_date_year}}</span> (jangka waktu kontrak).
                    </li>
                    <li>
                        Addendum Perjanjian kemitraan ini merupakan bagian yang tidak terpisahkan dari Perjanjian kemitraan, dengan demikian
                        mempunyai kekuatan hukum yang sama mengikat dengan Pasal-Pasal lain dalam Perjanjian kemitraan.

                    </li>
                    <li>
                        Ketentuan lain yang telah diatur dalam Perjanjian kemitraan yang tidak secara tegas diubah dengan Addendum Perjanjian
                        kemitraan ini tetap berlaku dan mengikat <span>PARA PIHAK</span>.
                    </li>
                    <li>
                        Addendum Perjanjian kemitraan ini dibuat dan ditandatangani oleh <span>PARA PIHAK</span> dalam rangkap 2 (dua); dan mempunyai
            ...
            <div class="content-sign">
                <div class="content-left">
                    <div class="sign-header"><span><span>PIHAK PERTAMA</span></span></div>
                    <div class="sign-name">{{$contract->approver}}<br>{{$contract->approver_position2}}</div>
                </div>
                <div class="content-right">
                    <div class="sign-header"><span><span>PIHAK KEDUA</span></span></div>
