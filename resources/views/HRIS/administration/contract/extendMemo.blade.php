                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                        ...
                        <form id="formInputExtend"  class="form form-horizontal">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr  class="active validate">
                                            <td><label><input type="checkbox" checked='checked' disabled> Create Date</label></td>
                                            <td style="width:250px; text-align:right"></td>
                                            <td> <input autocomplete="off" type="text" class="form-control date-picker" name="create_date" id="create_date"  value="{{date('d-M-Y')}}"> </td>
                                        </tr>
                                        <tr  class="active validate">
                                ...
                                @endphp
                                <button type="submit" class="btn green" id="btnSubmit" disabled>Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script type="text/javascript">
        ...
        $("#buttonConfrim").click(function(){
            ...
            $.ajax({
                ...
                url: "{{ URL::asset(env('APP_URL').'/hris/administration/contract/doextendMemo') }}",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
...
function preview(){
    ...
    $('#create_date_mod').html($('#create_date').val());
