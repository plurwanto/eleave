    ...
    <div id="content">
        ...
        <div class="content-text">
            ...
            <div class="article-2">
                ...
                <ol type="1">
                    <li>
                        ...
                        <span>{{$contract->position}}</span> dengan status/kedudukan sebagai Pekerja dengan
            ...
            <div class="article-3">
                ...
                <ol type="1">
                    <li>
                        Perjanjian Kerja ini berlaku sejak tanggal <span>{{$contract->start_date_day_numb}} {{$contract->start_date_month}} {{$contract->start_date_year}}</span> sampai dengan
                        <span>{{$contract->end_date_day_numb}} {{$contract->end_date_month}} {{$contract->end_date_year}}</span> tanggal atau sampai dengan saat
