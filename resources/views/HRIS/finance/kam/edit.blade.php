...
<form id="formInputEdit"  class="form form-horizontal">
                ...
                <div class="portlet-body form">
                        <div class="col-md-12 ">
                            <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <textarea type="text" autocomplete="off" name="remark" class="form-control" >{{$letter_request->result->note}}</textarea>
                                    </div>
                            </div>
    ...
    <input type="hidden" name="id" value="{{$letter_request->result->let_id}}">
...
<script type="text/javascript">
        ...
        $(document).on("submit", "#formInputEdit", function (event)
        {
            ...
            $.ajax({
                ...
                url: "{{ URL::asset(env('APP_URL').'/hris/administration/letter-request/doedit') }}",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
