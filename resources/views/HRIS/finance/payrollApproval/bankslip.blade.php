...
<form id="formInputBankslip"  class="form form-horizontal">
...
<script type="text/javascript">
        ...
        $(document).on("submit", "#formInputBankslip", function (event)
        {
            $('.loading').show();
            //stop submit the form, we will post it manually.
            event.preventDefault();
            // Get form
            var form = $('#formInputBankslip')[0];
            ...
            $.ajax({
                ...
                url: "{{ URL::asset(env('APP_URL').'/hris/finance/payroll/approval/dobankslip') }}",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
