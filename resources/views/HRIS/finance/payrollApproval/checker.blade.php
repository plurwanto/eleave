...
<form id="formInputChecker"  class="form form-horizontal">
                ...
                <div class="portlet-body form">
                        <div class="col-md-12 ">
                            <div class="form-body">
                                ...
                                <div class="form-group validate">
                                    <label class="col-md-3 control-label">Reference <font color="red">*</font></label>
                                    <div class="col-md-9">
...
<script type="text/javascript">
        ...
        $(document).on("submit", "#formInputChecker", function (event)
        {
            $('.loading').show();
            //stop submit the form, we will post it manually.
            event.preventDefault();
            // Get form
            var form = $('#formInputChecker')[0];
            ...
            $.ajax({
                ...
                url: "{{ URL::asset(env('APP_URL').'/hris/finance/payroll/approval/dochecker') }}",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
