            ...
            <div class="row">
                <div class="col-md-12" style="border-bottom: 1px solid #444d58; ">
                    ...
                    <div class="col-md-4" style="padding: 0px 30px;">
                        <div class="form-group form-margin-0">
                            <div>
                                <label style="font-weight: bold;">KPJ Number</label>
                                <div>{{$employee->employee->mem_jamsostek !=''? $employee->employee->mem_jamsostek : 'none'}}</div>
                            </div>
                            <div style="clear: both; margin-bottom: 10px;"></div>
                            <div>
                                <label style="font-weight: bold;">Jaminan Pensiun Number</label>
                                <div>{{$employee->employee->mem_bpjs_pen !=''? $employee->employee->mem_bpjs_pen : 'none'}}</div>
                            </div>
                            <div style="clear: both; margin-bottom: 10px;"></div>
                            <div>
                                <label style="font-weight: bold;">VA BPJS Kesehatan</label>
                                <div>{{$employee->employee->mem_bpjs_kes !=''? $employee->employee->mem_bpjs_kes : 'none'}}</div>
                            </div>
                        </div>
                    </div>
                </div>
