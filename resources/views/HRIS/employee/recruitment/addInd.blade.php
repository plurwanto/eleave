                        ...
                        <div class="portlet-body">
                                ...
                                <div class="expatriate-only" style="display:none">
                                    <div class="col-md-12" style="padding: 10px 15px">
                                        ...
                                        <div class="col-md-8 validate">
                                            <input autocomplete="off" type="text"  name="passport" value="{{$employee->employee->mem_ktp_no}}" class="form-control" style="border: 1px solid #BDBDBD; font-size: 12px; color: #414040; border-radius: 3px !important; height: 31px;">
                                        </div>
                                    </div>
                                    <div class="col-md-12" style="padding: 10px 15px">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 validate">
                                            <input autocomplete="off"  name="passport_date" placeholder="Enter Expire Date" type="text" class="form-control" style="border: 1px solid #BDBDBD; font-size: 12px; color: #414040; border-radius: 3px !important; height: 31px;">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="padding: 10px 15px">
                                    ...
                                    <div class="col-md-8 validate">
                                        <input autocomplete="off" name="bpjs_ket" placeholder="Enter Number" type="text" class="form-control" style="border: 1px solid #BDBDBD; font-size: 12px; color: #414040; border-radius: 3px !important; height: 31px;" placeholder="Enter KPJ Number">
                                    </div>
                                </div>
                                <div class="col-md-12" style="padding: 10px 15px">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 validate">
                                        <input autocomplete="off" name="bpjs_pen" placeholder="Enter Number"  type="text" class="form-control" style="border: 1px solid #BDBDBD; font-size: 12px; color: #414040; border-radius: 3px !important; height: 31px;" placeholder="Enter Jaminan Pensiun Number">
                                    </div>
                                </div>
                                <div class="col-md-12" style="padding: 10px 15px">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 validate">
                                        <input autocomplete="off" name="bpjs_kes" placeholder="Enter Number" type="text" class="form-control" style="border: 1px solid #BDBDBD; font-size: 12px; color: #414040; border-radius: 3px !important; height: 31px;" placeholder="Enter VA BPJS Kesehatan">
                                    </div>
                                </div>
                            </div>
