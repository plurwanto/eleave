                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="padding: 10px 15px">
                                    ...
                                    <div class="col-md-8 validate">
                                        <input autocomplete="off" name="tha_name" placeholder="Enter Name" type="text" class="form-control name" style="border: 1px solid #BDBDBD; font-size: 12px; color: #414040; border-radius: 3px !important; height: 31px;">
                                    </div>
                                </div>
                                <div class="col-md-12" style="padding: 10px 15px">
                                    <div class="col-md-4">
                                ...
                                <div class="col-md-12" style="padding: 10px 15px">
                                    ...
                                    <div class="col-md-8 validate">
                                        <textarea name="tha_address" placeholder="Enter Address" class="form-control address" style="border: 1px solid #BDBDBD; font-size: 12px; color: #414040; border-radius: 3px !important; min-height: 30px; overflow:hidden; resize: none;" onkeyup="setHeight.call(this);">{{$employee->employee->mem_address}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12" style="padding: 10px 15px">
                                    <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="padding: 10px 15px">
                                    ...
                                    <div class="col-md-8 validate">
                                        <input autocomplete="off" name="homebase" placeholder="Enter Homebase" type="text" class="form-control" style="border: 1px solid #BDBDBD; font-size: 12px; color: #414040; border-radius: 3px !important; height: 31px;">
                                    </div>
                                </div>
                            </div>
