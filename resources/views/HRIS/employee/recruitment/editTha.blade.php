                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="padding: 10px 15px">
                                    ...
                                    <div class="col-md-8 validate">
                                    <input name="tha_name" value="{{$employee2->employee->mem_name_tha}}" type="text" class="form-control" placeholder="Enter Name">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12" style="padding: 10px 15px">
                                    ...
                                    <textarea name="tha_address" type="text" class="form-control" placeholder="Enter Address"
                                        style="height: 103px;">{{$employee2->employee->mem_address_tha}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12" style="padding: 10px 15px">
                                    <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="padding: 10px 15px">
                                    ...
                                    <div class="col-md-8 validate">
                                        <input name="homebase" type="text"  value="{{$employee2->employee->homebase}}" class="form-control" placeholder="Enter Homebase">
                                    </div>
                                </div>
                            </div>
                        </div>
