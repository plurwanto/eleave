                        ...
                        <div class="portlet-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="padding: 10px 15px">
                                    ...
                                    <div class="col-md-8 validate">
                                        <select name="user_level" id="user_level" autocomplete="off" class="form-control">
                                            <option value="">-- Choose a Level --</option>
                                            @php
                                            $level =['1','2'];
                                            for($i = 0; $i < count($level); $i++){
                                                if($employee2->employee->mem_security_level == $level[$i]){
                                ...
                                <div class="col-md-12" style="padding: 10px 15px">
                                    ...
                                    <div class="col-md-8 validate">
                                        <input type="text" name="tin"  value="{{$employee2->employee->mem_tin_no}}" class="form-control" placeholder="Enter Number">
                                    </div>
                                </div>
                                <div class="col-md-12" style="padding: 10px 15px">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 validate">
                                        <input type="text" name="phic" value="{{$employee2->employee->mem_phic_no}}" class="form-control" placeholder="Enter Number">
                                    </div>
                                </div>
                                <div class="col-md-12" style="padding: 10px 15px">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 validate">
                                        <input type="text" name="sss"  value="{{$employee2->employee->mem_sss_no}}" class="form-control" placeholder="Enter Number">
                                    </div>
                                </div>
                                <div class="col-md-12" style="padding: 10px 15px">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 validate">
                                        <input type="text" name="hdmf"  value="{{$employee2->employee->mem_hdmf_no}}" class="form-control" placeholder="Enter Number">
                                    </div>
                                </div>
