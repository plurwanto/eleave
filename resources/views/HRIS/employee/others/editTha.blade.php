...
<div class="modal-body" style="padding-bottom: 0;">
                        ...
                        <div style="padding: 0px 30px;" class="col-md-6">
                            <div class="form-group form-margin-0">
                                ...
                                <div class="validate">
                                    ...
                                    <input name="tha_name" value="{{$employee->employee->mem_name_tha}}" type="text" class="form-control" placeholder="Enter Name">
                                </div>
                                <div style="clear: both; margin-bottom: 10px;"></div>
                                <div class="validate">
                        ...
                        <div class="col-md-6" style="padding: 0px 30px;">
                            <div class="form-group form-margin-0">
                                ...
                                <div id="passport" style="display:none">
                                    <div class="validate col-md-6" style="padding-left: 0">
                                    ...
                                    <div class="validate col-md-6" style="padding-right: 0">
                        ...
                        <div class="col-md-4" style="padding: 0px 30px;">
                            <div class="form-group form-margin-0">
                                <div class="validate">
                                    ...
                                    <input name="homebase" type="text"  value="{{$employee->employee->homebase}}" class="form-control" placeholder="Enter Homebase">
                                </div>
                                <div style="clear: both; margin-bottom: 10px;"></div>
                                <div class="validate">
                                    <label style="font-weight: bold;">Address in Thailand</label>
                                    <textarea name="tha_address" type="text" class="form-control" placeholder="Enter Address"
                                        style="height: 103px;">{{$employee->employee->mem_address_tha}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-footer">
        ...
        <input type="hidden" value="4" name="form_type" id="form_type" class="form-control">
        ...
        $(document).ready(function () {
            ...
            $('#formInputEdit').validate({
                rules: {
                    ...
                    ac_bank2: {
                        number: true,
                        remote: "{{ URL::asset(env('APP_URL').'/hris/employee/others/check-bank-exising-edit') }}"
                    },
                    swift: {
                        required: true
                    },
