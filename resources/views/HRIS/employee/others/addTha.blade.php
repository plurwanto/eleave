...
<form id="formInput"  class="form form-horizontal">
                        ...
                        <div style="padding: 0px 30px;" class="col-md-6">
                            <div class="form-group form-margin-0">
                                ...
                                <div class="validate">
                                    ...
                                    <input name="tha_name" type="text" class="form-control" placeholder="Enter Name">
                                </div>
                                <div style="clear: both; margin-bottom: 10px;"></div>
                                <div class="validate">
                        ...
                        <div class="col-md-4" style="padding: 0px 30px;">
                            <div class="form-group form-margin-0">
                                <div class="validate">
                                    ...
                                    <input name="homebase" type="text" class="form-control" placeholder="Enter Homebase">
                                </div>
                                <div style="clear: both; margin-bottom: 10px;"></div>
                                <div class="validate">
    ...
    <div class="modal-footer">
        <input type="hidden" value="4" name="form_type" id="form_type" autocomplete="off" class="form-control">
            ...
            htm='<div class="form-group">'+
                ...
                '<div class="form-group">'+
                    '<label>Passport Expire Date</label>'+
                        '<input name="passport_date" type="text" class="form-control" id="dp" onclick="$(\'#dp\').datepicker();$(\'#dp\').datepicker(\'show\');" data-date-format="dd/mm/yyyy">'+
                '</div>';
         }else{
            htm='';
         }
