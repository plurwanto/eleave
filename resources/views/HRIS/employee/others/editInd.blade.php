                        ...
                        <div class="col-md-4" style="padding: 0px 30px;">
                            <div class="form-group form-margin-0">
                                <div class="validate">
                                    ...
                                    <input type="text" name="bpjs_ket"  value="{{$employee->employee->mem_jamsostek}}" autocomplete="off" class="form-control" placeholder="Enter Number">
                                </div>
                                <div style="clear: both; margin-bottom: 10px;"></div>
                                <div>
                                    <label style="font-weight: bold;">Jaminan Pensiun Number <small>(optional)</small></label>
                                    <input type="text" name="bpjs_pen" value="{{$employee->employee->mem_bpjs_pen}}" autocomplete="off" class="form-control" placeholder="Enter Number">
                                </div>
                                <div style="clear: both; margin-bottom: 10px;"></div>
                                <div>
                                    <label style="font-weight: bold;">VA BPJS Kesehatan <small>(optional)</small></label>
                                    <input type="text" name="bpjs_kes" value="{{$employee->employee->mem_bpjs_kes}}" autocomplete="off" class="form-control" placeholder="Enter Number">
                                </div>
                            </div>
                        </div>
                    </div>
