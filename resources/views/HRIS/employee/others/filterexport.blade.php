...
<form id="formInput"  class="form form-horizontal">
                          ...
                          <div class="portlet-body form">
                                <div class="form-body">
                                    <div class="form-group">
                                        <label for="exampleInputFile" class="col-md-3 control-label">Join Year <font color="red">*</font></label>
                                        <div class="col-md-7">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn green" id="btnSubmit">Export Excel</button>
    </div>
</form>
...
<script type="text/javascript">
        ...
        $(document).on("submit", "#formInput", function (event)
        {
            ...
            $.ajax({
                ...
                url: "{{ URL::asset(env('APP_URL').'/hris/employee/others/export-excel') }}",
                data:"year="+year,
                processData: false,
                contentType: false,
                cache: false,
