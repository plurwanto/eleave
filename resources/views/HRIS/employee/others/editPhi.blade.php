...
<form id="formInputEdit"  class="form form-horizontal">
                            ...
                            <div class="form-group form-margin-0">
                                ...
                                <div>
                                    <div class="col-md-6" style="padding-left: 0">
                                        ...
                                        <input type="radio" name="citizenship" id="citizenship"  value="local" checked="checked" onclick="$('#id_card').show(); $('#passport').hide(); $('#bank2').hide();">
                                        @else
                                        <input type="radio" name="citizenship" id="citizenship"  value="local" onclick="$('#id_card').show(); $('#passport').hide(); $('#bank2').hide();">
                                        @endif
                                            Local
                                            <span></span>
                                        </label>
                                        ...
                                        <input type="radio" name="citizenship" id="citizenship"  value="expatriate" checked="checked" onclick="$('#id_card').hide(); $('#passport').show(); $('#bank2').show();">
                                        @else
                                        <input type="radio" name="citizenship" id="citizenship"  value="expatriate" onclick="$('#id_card').hide(); $('#passport').show(); $('#bank2').show();">
                                        @endif
                                        Expatriate
                                            <span></span>
                                        </label>
                                    ...
                                    <div class="col-md-6" style="padding-right: 0">
                                        ...
                                        <div class="mt-radio-inline" style="padding-top: 7px;padding-bottom: 9px;">
                                            <label class="mt-radio" style="margin-bottom: 0;">
                                                @if($employee->employee->mem_security_level =='1')
                                                <input type="radio" name="user_level" id="user_level"  value="1" checked="checked">
                                                @else
                                                <input type="radio" name="user_level" id="user_level"  value="1">
                                                @endif
                                                    1
                                                    <span></span>
                                                </label>
                                                <label class="mt-radio" style="margin-bottom: 0;">
                                                @if($employee->employee->mem_security_level =='2')
                                                <input type="radio" name="user_level" id="user_level"  value="2" checked="checked">
                                                @else
                                                <input type="radio" name="user_level" id="user_level"  value="2">
                                                @endif
                                                2
                                                    <span></span>
                                            </label>
                        ...
                        <div class="col-md-3" style="padding: 0 30px 0 22px">
                            <div class="form-group form-margin-0">
                                <div class="validate">
                                    ...
                                    <input type="text" name="tin"  value="{{$employee->employee->mem_tin_no}}" class="form-control" placeholder="Enter Number">
                                </div>
                                <div style="clear: both; margin-bottom: 10px;"></div>
                                <div>
                                    <label style="font-weight: bold;">PHIC No.</label>
                                    <input type="text" name="phic" value="{{$employee->employee->mem_phic_no}}" class="form-control" placeholder="Enter Number">
                                </div>
                                <div style="clear: both; margin-bottom: 10px;"></div>
                                <div class="validate">
                                    <label style="font-weight: bold;">SSS No.</label>
                                    <input type="text" name="sss"  value="{{$employee->employee->mem_sss_no}}" class="form-control" placeholder="Enter Number">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3" style="padding-right: 30px;">
                            <div class="form-group form-margin-0">
                                <div>
                                    ...
                                    <input type="text" name="hdmf"  value="{{$employee->employee->mem_hdmf_no}}" class="form-control" placeholder="Enter Number">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style="padding: 0px 30px;" class="col-md-4">
                            <div class="form-group form-margin-0">
                                ...
                                <div class="validate">
                                    ...
                                    <input type="text" name="ac_bank2" value="{{$employee->employee->mem_bank_ac2}}" id="ac_bank2" autocomplete="off" class="form-control" placeholder="Enter Account Number">
                                </div>
                                <div style="clear: both; margin-bottom: 10px;"></div>
                                <div class="validate">
                                    <label style="font-weight: bold;">Account Name (Secondary)</label>
                                    <input type="text" name="an_bank2"  value="{{$employee->employee->mem_bank_an2}}" id="an_bank2" autocomplete="off" class="form-control" placeholder="Enter Account Name">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group form-margin-0">
                                <div class="validate">
                                    ...
                                    <input type="text" name="swift" value="{{$employee->employee->swift_no}}" id="swift" autocomplete="off" class="form-control" placeholder="Enter Account Name">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group form-margin-0">
                                <div class="validate">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <small>Name</small>
                                            <input type="text" name="name_spouse"  value="{{$employee->employee->mem_spouse_name}}" autocomplete="off" class="form-control" placeholder="Enter Name">
                                        </div>
                                        <div class="col-md-4">
    ...
    <div class="modal-footer">
        ...
        <input type="hidden" value="2" name="form_type" id="form_type" class="form-control">
...
<script type="text/javascript">
        ...
        $(document).on("submit", "#formInputEdit", function (event)
        {
            ...
            $.ajax({
                ...
                url: "{{ URL::asset(env('APP_URL').'/hris/employee/others/doedit') }}",
                data: data,
                processData: false,
                contentType: false,
                cache: false,
