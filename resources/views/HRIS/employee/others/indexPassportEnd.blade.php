                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light ">
                            ...
                            <th>id. </th>
                                ...
                                <th> Interval Passport Expire </th>
                                <th> Updated By </th>
                            </tr>
                            </thead>
                            <thead>
                            ...
                            <th></th>
                                ...
                                <th><input type="text" data-column="7"  class="search-input-text form-control input-sm   border-rounded" placeholder="Search User"></th>
                            </tr>
                            </thead>
                        </table>
                        </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var dataTable = $('#users-table').DataTable({
                    ...
                    "order": [[ 0, "DESC" ]],
                    "ajax": {
                        "url": "{{ URL::asset(env('APP_URL').'/hris/employee/others/listdata-passport-end') }}",
                        "dataType": "json",
                        "type": "POST",
                    ...
                    "columns": [
                        ...
                        { data: 'mem_exp_passport', name: 'mem_exp_passport' },
                        { data: 'int_mem_exp_passport', name: 'int_mem_exp_passport' },
