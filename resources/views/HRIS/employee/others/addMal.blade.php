...
<div class="modal-body" style="padding-bottom: 0;">
    ...
    <div class="modal-footer">
        <input type="hidden" value="5" name="form_type" id="form_type" class="form-control">             <button class="btn dark btn-outline" data-dismiss="modal">Close</button>
