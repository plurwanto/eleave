                            ...
                            <th></th>
                                ...
                                <th>
                                    <select data-column="4" name="customer" class="search-input-select form-control input-sm select2">
                                            ...
                                            <option value="2">Philiphin</option>
                                ...
                                <th>
                                    <select data-column="5" name="customer" class="search-input-select form-control input-sm select2">
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var dataTable = $('#users-table').DataTable({
                    ...
                    "order": [[ 0, "DESC" ]],
                    "ajax": {
                        "url": "{{ URL::asset(env('APP_URL').'/hris/employee/others/listdata') }}",
                        "dataType": "json",
                        "type": "POST",
            ...
            function get_modal(e)
            {
                ...
                if (action == 'type') {
                    $('#modalAction').modal({backdrop: 'static', show: true, keyboard: false});
                    var id = $(this).attr('data-column');
                    $.get("{{ URL::asset(env('APP_URL').'/hris/employee/others/form-type') }}",
                    {
                        link: link,
                        id: arr[0]
                    },
