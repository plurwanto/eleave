...
<script type="text/javascript">
        ...
        if (name_child == '' || dataid == 3) {
            ...
            htm =   '<div id="row_' + newdataid + '" class="row">'+
                        ...
                        '</div>'+
                        '<div class="col-md-4">'+
                            '<select name="gender_child' + newdataid + '" id="gender_child' + newdataid + '" class="form-control" readonly>'+
    ...
    function deleteFunctionChild(e) {
        ...
        if (name_bank == ''|| dataid == 2) {
            ...
            htm ='  <div class="row" id="rowbank' + newdataid + '">'+
                            '<div class="col-md-4">'+
                                '<div class="form-group">'+
                                        '<select name="name_bank' + newdataid + '" id="name_bank' + newdataid + '" class="form-control" readonly>'+
